...
def parseArgs(argv):
	...
	parser.add_argument('-q', '--min_mapq', 
		...
		default = 20, type = int)
	parser.add_argument('-r', '--min_read_len', 
	...
	parser.add_argument('--diff_ratio_filtering_INS', 
		help = "Filter breakpoints with basepair identity less than [%(default)s] for insertion.", 
		default = 0.6, type = float)

	# ++++++DEL++++++
	parser.add_argument('--max_cluster_bias_DEL', 
	...
	parser.add_argument('--diff_ratio_filtering_DEL', 
